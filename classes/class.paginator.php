...
class Paginator{
    ...
    */
    ...
    public function page_links($path='?',$ext=null)
    {
        ...
        if ($this->_page > 1)
            $pagination.= "<li><a aria-label='Previous' href='".$path."$this->_instance=$prev"."$ext'><span aria-hidden='true'>&laquo;</span></a></li>";
        else
        ...
        {
        if ($counter == $this->_page)
            $pagination.= "<li><a href='#'>$counter<span class='sr-only'>(current)</span></a></li>";
        else
            $pagination.= "<li><a href='".$path."$this->_instance=$counter"."$ext'>$counter</a></li>";
        }
        }
        ...
        if ($this->_page < $counter - 1)
            $pagination.= "<li><a href='".$path."$this->_instance=$next"."$ext'><span aria-hidden='true'>&raquo;</span></a></li>";
        else
